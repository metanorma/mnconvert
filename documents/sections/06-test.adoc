...
Determine the mass fraction of moisture in accordance with the method specified in std-link:[ISO 712].
...
Determine the nitrogen content and crude protein content in accordance with either std-link:[ISO 16634:--,clause=9], or <<norm_ref_6,ISO 20483:2013>>. For details on the determination of protein content using the Kjeldahl method, see Reference <<ref_10,<<ref_10>>>> in the Bibliography. For details concerning the use of the Dumas method, see References <<ref_15,<<ref_15>>>> and <<ref_16,<<ref_16>>>>.
...
Determine the husked rice yield in accordance with std-link:[ISO 6646].
