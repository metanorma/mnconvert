...
The mass fraction of moisture, determined in accordance with std-link:[ISO 712], using an oven complying with the requirements of <<ref_9,IEC 61010-2:1998>>, shall not be greater than 15 %. footnote:[Formerly denoted as 15 % (m/m).]
