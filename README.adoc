...
[source,sh]
----
java -jar mnconvert-1.10.0.jar xml_file --check-type xsd-niso
----
...
[source,sh]
----
java -jar mnconvert-1.10.0.jar xml_file [options]
----
...
[source,sh]
----
java -jar target/mnconvert-1.10.0.jar tests/iso-tc154-8601-1-en.xml --output tests/iso-tc154-8601-1-en.out.xml
----
