...
[source,sh]
----
java -jar mnconvert-1.58.0.jar xml_file --check-type xsd-niso
----
...
[source,sh]
----
java -jar mnconvert-1.58.0.jar xml_file [options]
----
...
[source,sh]
----
java -jar mnconvert-1.58.0.jar docx_file [options]
----
...
[source,sh]
----
java -jar mnconvert-1.58.0.jar xml_file --output-format ieee --validation-against <path to IEEE DTD>
----
...
[source,sh]
----
java -jar target/mnconvert-1.58.0.jar tests/iso-tc154-8601-1-en.xml --output tests/iso-tc154-8601-1-en.out.xml
----
