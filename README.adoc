...
[source,sh]
----
java -jar mnconvert-1.9.0.jar xml_file --check-type xsd-niso
----
...
[source,sh]
----
java -jar mnconvert-1.9.0.jar xml_file [options]
----
...
=== 4. Convert XML2RFC to Metanorma adoc.
...
[source,sh]
----
java -jar target/mnconvert-1.9.0.jar tests/iso-tc154-8601-1-en.xml --output tests/iso-tc154-8601-1-en.out.xml
----
